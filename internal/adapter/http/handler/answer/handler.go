...
type Handler struct {
	answerUC usecase.Answer
	log      *zap.Logger
}

func NewHandler(answerUC usecase.Answer, log *zap.Logger) *Handler {
	return &Handler{answerUC: answerUC, log: log}
}
...
func (h *Handler) Create(c *gin.Context) {
	...
	resp, err := h.answerUC.CreateAnswer(c.Request.Context(), req)
	if err != nil {
		h.handleError(c, err)
		return
	}
...
func (h *Handler) GetByID(c *gin.Context) {
	...
	resp, err := h.answerUC.GetAnswer(c.Request.Context(), id)
	if err != nil {
		h.handleError(c, err)
		return
	}
...
func (h *Handler) GetAll(c *gin.Context) {
	...
	resp, err := h.answerUC.GetAllAnswers(c.Request.Context(), questionID, limit, offset)
	if err != nil {
		h.handleError(c, err)
		return
	}
...
func (h *Handler) Update(c *gin.Context) {
	...
	resp, err := h.answerUC.UpdateAnswer(c.Request.Context(), id, req)
	if err != nil {
		h.handleError(c, err)
		return
	}
...
func (h *Handler) Delete(c *gin.Context) {
	...
	resp, err := h.answerUC.DeleteAnswer(c.Request.Context(), id)
	if err != nil {
		h.handleError(c, err)
		return
	}
